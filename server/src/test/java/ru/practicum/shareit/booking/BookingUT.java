...
public class BookingUT {
    ...
    void getBookings() {
        ...
        List<Booking> getBookings1 = ReflectionTestUtils.invokeMethod(BookingServiceImpl.class, "getBookings", BookingStatusDto.CURRENT, bookings);
        List<Booking> getBookings2 = ReflectionTestUtils.invokeMethod(BookingServiceImpl.class, "getBookings", BookingStatusDto.PAST, bookings);
        List<Booking> getBookings3 = ReflectionTestUtils.invokeMethod(BookingServiceImpl.class, "getBookings", BookingStatusDto.FUTURE, bookings);
        ...
        List<Booking> getBookings6 = ReflectionTestUtils.invokeMethod(BookingServiceImpl.class, "getBookings", BookingStatusDto.ALL, bookings);
